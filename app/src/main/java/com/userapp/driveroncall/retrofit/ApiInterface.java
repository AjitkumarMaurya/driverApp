package com.userapp.driveroncall.retrofit;

import com.userapp.driveroncall.response.CancelResponce;
import com.userapp.driveroncall.response.CompleteTripResponce;
import com.userapp.driveroncall.response.ContactUsResponse;
import com.userapp.driveroncall.response.CreateTripResponse;
import com.userapp.driveroncall.response.ForgotChengPassResponse;
import com.userapp.driveroncall.response.ForgotOtpPassResponse;
import com.userapp.driveroncall.response.ForgotOtpResponse;
import com.userapp.driveroncall.response.GetTripRateResponse;
import com.userapp.driveroncall.response.LoginResponse;
import com.userapp.driveroncall.response.MyBookResponce;
import com.userapp.driveroncall.response.MyTripsResponse;
import com.userapp.driveroncall.response.OtpResponse;
import com.userapp.driveroncall.response.OtpVerification;
import com.userapp.driveroncall.response.PasswordForgetResponse;
import com.userapp.driveroncall.response.PaymentInfoResponce;
import com.userapp.driveroncall.response.ProfileUsResponse;
import com.userapp.driveroncall.response.RatingResponce;
import com.userapp.driveroncall.response.RegistesonResponse;
