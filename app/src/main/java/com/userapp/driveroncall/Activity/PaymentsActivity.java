            ...
            public void onResponse(Call<PaymentInfoResponce> call, Response<PaymentInfoResponce> response) {
                ...
                if (response!=null && response.isSuccessful()){
                    ...
                    if (paymentInfoResponce != null) {
                        ...
                        tv_date_time.setText("" + paymentInfoResponce.getPaymentDetails().getTripStartDate());
                        ...
                        if (paymentInfoResponce.getPaymentDetails().getTripAmount().toString().equalsIgnoreCase("1")) {
